...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  Future<void> _fetchUsers(String query) async {
    ...
    try {
      // Fetch all particpants from Firestore
  ...
  void _createEvent() async {
    ...
    try {
      ...
      // Create a new event document in the Firestore collection
      ...
      _showDialog('Event Created', 'Your event has been successfully created.');
    } catch (e) {
      _showDialog('Error', 'Failed to create event: $e');
    }
  }
